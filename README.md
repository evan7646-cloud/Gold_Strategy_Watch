...
## 回測績效 (對齊 backtest_4h_8h_full_metrics)

| 指標 | 4H 30MA (+2h Offset) 表現 |
|------|------|
| **累積總淨損益 (Total PnL)** | **+3,354.61 pts** |
| **最大點數回撤 (Max DD)** | **437.35 pts (極低回撤)** |
| **夏普比率 (Sharpe Ratio)** | **2.43** |
| **卡爾瑪比率 (Calmar Ratio)** | **4.97 (強大抗洗盤能力)** |
| **勝率 (Win Rate)** | **37.60%** |

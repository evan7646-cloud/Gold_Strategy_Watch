//+------------------------------------------------------------------+ // 頭部註釋
//|              Gold_4H_30MA_add2.0>3%_Strategy_Offset+3h.mq5 | // 檔名與模組註釋
...
//--- 策略參數設定 (與最終版 Gold_4H_30MA_add2.0>3%_Strategy_Offset+3h.mq5 100% 同步)
input ulong    InpMagicMain      = 44443001;         // 主部位 Magic Number
input ulong    InpMagicPyramid   = 44443002;         // 加倉部位 Magic Number
...
{ // 函數開頭
   ...
   return ((dt.hour + 1) % 4 == 0); // 判斷是否為 UTC +3h 偏移之 4H K 線關棒開盤點
} // 函數結束

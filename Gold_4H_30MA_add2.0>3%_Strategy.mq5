//+------------------------------------------------------------------+
//|                               Gold_4H_30MA_add2.0>3%_Strategy.mq5 |
//|                               黃金 4H 30MA 多空混合策略 EA        |
//|                               Version 2.00                        |
//+------------------------------------------------------------------+
...
int OnInit()
{
   ...
   PrintFormat("🚀 Gold 4H 30MA Hybrid Strategy EA 初始化成功！[MagicMain=%d, MagicPyramid=%d]", InpMagicMain, InpMagicPyramid); // 印出成功日誌

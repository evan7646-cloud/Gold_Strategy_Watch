//+------------------------------------------------------------------+ // 頭部註釋
//|              Gold_4H_30MA_add2.0>3%_Strategy_Offset+3h_FTMO.mq5 | // 檔名與模組註釋
...
input ulong    InpMagicMain      = 77773001;         // 主部位 Magic Number
input ulong    InpMagicPyramid   = 77773002;         // 加倉部位 Magic Number
